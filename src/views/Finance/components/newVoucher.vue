                ...
                <el-main>
                    <el-container>
                       ...
                       <el-main class="formTable">
                        ...
                        <!--底部信息-->
                        <b class="staffInfo">制单人：<span>{{Nick}}</span></b>
                        <div class="staff_btn">
                             <el-button type="warning" v-on:click="btnSave(1)">保 存</el-button>
                             <el-button type="success" v-on:click="btnSave(2)">保存并新增</el-button>
                        </div>
                       </el-main>
                    </el-container>
                </el-main>
